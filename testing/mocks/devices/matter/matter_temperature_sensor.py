...
class MatterTemperatureSensor(MatterDevice):
    """
    Represents a standalone Matter temperature sensor backed by a matter.js
    virtual device with a single endpoint (device type 0x0302).
    """
