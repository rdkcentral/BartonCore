...
/**
 * IkeaTimmerflotteDevice - A matter.js virtual device representing the IKEA
 * TIMMERFLOTTE temperature/humidity sensor for integration testing.
 *
 ...
 *
 * Bakes in the IKEA vendor ID (0x117C) and TIMMERFLOTTE product ID (0x8005)
 * so the vendor-specific SBMD driver claims this device by identity.
 *
