...
def test_commission_temperature_sensor(
    ...
    """Commission a temperature sensor and verify the temperature resource."""
...
def test_temperature_sensor_update(
    default_environment, matter_temperature_sensor
):
    """Update temperature via side-band and verify Barton receives it."""
    commission_device(
        default_environment,
        matter_temperature_sensor,
        "environmentalSensor",
