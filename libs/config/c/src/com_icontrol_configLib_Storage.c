...
Java_com_icontrol_configLib_Storage_save(JNIEnv *env, jclass clazz, jstring jnamespace, jstring jkey, jstring jvalue)
{
...
JNIEXPORT jstring JNICALL Java_com_icontrol_configLib_Storage_load(JNIEnv *env,
                                                                   jclass clazz,
                                                                   jstring jnamespace,
                                                                   jstring jkey)
{
...
JNIEXPORT jboolean JNICALL Java_com_icontrol_configLib_Storage_delete(JNIEnv *env,
                                                                      jclass clazz,
                                                                      jstring jnamespace,
                                                                      jstring jkey)
{
...
JNIEXPORT jboolean JNICALL Java_com_icontrol_configLib_Storage_deleteNamespace(JNIEnv *env,
                                                                               jclass clazz,
                                                                               jstring jnamespace)
{
    const jchar *namespace = NULL;
