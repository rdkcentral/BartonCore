...
namespace barton
{
    ...
    public:
        ...
        //TODO move to hidden/internal and not expose?
        ...
        /**
         * Asynchronously read an attribute directly from the device (over the air).
         * This does not use the cache and initiates a fresh read operation.
         *
         * @param endpointId The endpoint ID to read from.
         * @param clusterId The cluster ID to read from.
         * @param attributeId The attribute ID to read.
         * @param onSuccess Callback function invoked on successful read with a TLVReader positioned at the attribute data.
         * @return A future that resolves to CHIP_NO_ERROR on success or an error code on failure.
         */
        std::future<CHIP_ERROR> GetAttributeData(chip::EndpointId endpointId,
                                                 chip::ClusterId clusterId,
                                                 chip::AttributeId attributeId,
                                                 std::function<void(chip::TLV::TLVReader&)> onSuccess);
         ...
         * Otherwise, it may involve an asynchronous read from the device.
         *
