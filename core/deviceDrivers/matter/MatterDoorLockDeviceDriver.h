...
namespace zilker
{
    class MatterDoorLockDeviceDriver : public MatterDeviceDriver, DoorLock::EventHandler {
    public:
        ...
        void LockStateChanged(std::string &deviceUuid, chip::app::Clusters::DoorLock::DlLockState lockState, void *asyncContext) override;
        void LockStateReadComplete(std::string &deviceUuid, chip::app::Clusters::DoorLock::DlLockState lockState, void *asyncContext) override;
