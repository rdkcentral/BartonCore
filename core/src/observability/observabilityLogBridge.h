...
/**
 * Initialize the log bridge. Call after observabilityInit().
 * Registers a hook so that icLog messages are also emitted as observability log records.
 *
...
/**
 * Shut down the log bridge and deregister the icLog hook.
 */
