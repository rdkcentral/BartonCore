...
namespace zilker
{
    ...
    bool DeviceInfoProviderImpl::FixedLabelIteratorImpl::Next(FixedLabelType &output)
    {
        ...
        ChipLogProgress(
            DeviceLayer, "Get the fixed label with index:%u at endpoint:%d", static_cast<unsigned>(mIndex), mEndpoint);
    ...
    {
        return mStorage->SyncSetKeyValue(DefaultStorageKeyAllocator::UserLabelLengthKey(endpoint).KeyName(),
                                         &val,
    ...
    CHIP_ERROR DeviceInfoProviderImpl::SetUserLabelAt(EndpointId endpoint, size_t index, const UserLabelType &userLabel)
    {
        ...
        return mStorage->SyncSetKeyValue(DefaultStorageKeyAllocator::UserLabelIndexKey(endpoint, index).KeyName(),
                                         buf,
    ...
    DeviceInfoProviderImpl::UserLabelIteratorImpl::UserLabelIteratorImpl(DeviceInfoProviderImpl &provider,
                                                                         EndpointId endpoint) :
    ...
    bool DeviceInfoProviderImpl::UserLabelIteratorImpl::Next(UserLabelType &output)
    {
        ...
        err = mProvider.mStorage->SyncGetKeyValue(
            DefaultStorageKeyAllocator::UserLabelIndexKey(mEndpoint, mIndex).KeyName(), buf, len);
    ...
    size_t DeviceInfoProviderImpl::SupportedCalendarTypesIteratorImpl::Count()
    {
        ...
        // {("kBuddhist"), ("kChinese"), ("kCoptic"), ("kEthiopian"), ("kGregorian"), ("kHebrew"), ("kIndian"),
        // ("kJapanese"),
