...
std::string CertifierDACProvider::GetDACFilepath()
{
    ...
    g_autofree char *dacFilePath = b_core_property_provider_get_property_as_string(propertyProvider, DEVICE_PROP_MATTER_DAC_P12_PATH,  "");
...
{
    g_autoptr(BCorePropertyProvider) propertyProvider = deviceServiceConfigurationGetPropertyProvider();
    g_autofree char *dacPassword = b_core_property_provider_get_property_as_string(propertyProvider, DEVICE_PROP_MATTER_DAC_P12_PASSWORD, "");
