...
static void test_deviceCommunicationWatchdogInit(void **state)
{
    ...
    will_return(__wrap_b_device_service_property_provider_get_property_as_bool, false);
...
int main(int argc, const char **argv)
{
    const struct CMUnitTest tests[] = {
        cmocka_unit_test(test_deviceCommunicationWatchdogInit),
        cmocka_unit_test(test_deviceCommunicationWatchdogMonitorDevice),
        cmocka_unit_test(test_deviceCommunicationWatchdogForceDeviceInCommFail),
        cmocka_unit_test(test_deviceCommunicationWatchdogSetTimeRemaining),
        cmocka_unit_test(test_deviceCommunicationWatchdogTerm)
    };
