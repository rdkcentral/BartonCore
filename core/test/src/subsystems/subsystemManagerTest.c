...
void test_subsystem_migration(void **state)
{
    ...
    scoped_Subsystem mySubsystem = createTestSubsystem(subsystemName);
...
void test_subsystemManagerRegister(void **state)
{
    ...
    scoped_Subsystem mySubsystem = createTestSubsystem(NULL);
...
void test_subsystemManagerGetRegisteredSubsystems(void **state)
{
    ...
    scoped_Subsystem subsystem1 = createTestSubsystem(subsystemName1);
    ...
    scoped_Subsystem subsystem2 = createTestSubsystem(subsystemName2);
...
void test_subsystemManagerGetSubsystemStatusJson(void **state)
{
    ...
    scoped_Subsystem subsystem = createTestSubsystem(subsystemName);
...
void test_subsystemManagerShutdown(void **state)
{
    ...
    scoped_Subsystem mySubsystem2 = createTestSubsystem(subsystemName2);
