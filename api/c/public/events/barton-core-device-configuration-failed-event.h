...
#define B_CORE_DEVICE_CONFIGURATION_FAILED_EVENT_TYPE                                                        \
    (b_core_device_configuration_failed_event_get_type())
G_DECLARE_FINAL_TYPE(BCoreDeviceConfigurationFailedEvent,
 ...
 * @brief
 *
 * Returns: (transfer full): BCoreDeviceConfigurationFailedEvent*
 */
