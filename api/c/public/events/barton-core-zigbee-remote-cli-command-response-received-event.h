...
#define B_CORE_ZIGBEE_REMOTE_CLI_COMMAND_RESPONSE_RECEIVED_EVENT_TYPE                                        \
    (b_core_zigbee_remote_cli_command_response_received_event_get_type())
G_DECLARE_FINAL_TYPE(BCoreZigbeeRemoteCliCommandResponseReceivedEvent,
...
typedef enum
{
    B_CORE_ZIGBEE_REMOTE_CLI_COMMAND_RESPONSE_RECEIVED_EVENT_PROP_UUID = 1,
    B_CORE_ZIGBEE_REMOTE_CLI_COMMAND_RESPONSE_RECEIVED_EVENT_PROP_COMMAND_RESPONSE,
    N_B_CORE_ZIGBEE_REMOTE_CLI_COMMAND_RESPONSE_RECEIVED_EVENT_PROPERTIES
} BCoreZigbeeRemoteCliCommandResponseReceivedEventProperty;

static const char *B_CORE_ZIGBEE_REMOTE_CLI_COMMAND_RESPONSE_RECEIVED_EVENT_PROPERTY_NAMES[] = {
    NULL,
    "uuid",
    "command-response"};
 ...
 * @brief
 *
 * @return BCoreZigbeeRemoteCliCommandResponseReceivedEvent*
 */
