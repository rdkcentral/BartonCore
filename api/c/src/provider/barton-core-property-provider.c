...
#define LOG_TAG     "barton-core-property-provider"
#define logFmt(fmt) "%s: " fmt, __func__

G_DEFINE_INTERFACE(BCorePropertyProvider, b_core_property_provider, G_TYPE_OBJECT)
G_DEFINE_QUARK(b - device - service - property - provider - error - quark, b_core_property_provider_error)
...
static gchar *b_core_property_provider_get_internal_property(const gchar *property_name, GError **error);
static gboolean b_core_property_provider_set_internal_property(BCorePropertyProvider *self,
                                                                         const gchar *property_name,
                                                                         const gchar *property_value,
                                                                         GError **error);

static void b_core_propert_provider_emit_property_changed(BCorePropertyProvider *self,
                                                                    const gchar *property_name,
                                                                    const gchar *old_value,
                                                                    const gchar *new_value);


static void b_core_property_provider_default_init(BCorePropertyProviderInterface *iface)
{
    iface->emit_property_changed = b_core_propert_provider_emit_property_changed;
    iface->get_property = NULL;
    iface->set_property = NULL;

    signals[SIGNAL_PROPERTY_CHANGED] = g_signal_new(B_CORE_PROPERTY_PROVIDER_SIGNAL_PROPERTY_CHANGED,
...
gchar *b_core_property_provider_get_property(BCorePropertyProvider *self,
                                                       ...
                                                       GError **error)
{
    g_return_val_if_fail(B_CORE_IS_PROPERTY_PROVIDER(self), NULL);
    g_return_val_if_fail(error == NULL || *error == NULL, NULL);

    if (property_name == NULL)
    {
        g_set_error(error,
                    B_CORE_PROPERTY_PROVIDER_ERROR,
                    B_CORE_PROPERTY_PROVIDER_ERROR_ARG,
                    "Property name cannot be NULL");
        return NULL;
    }

    BCorePropertyProviderInterface *iface = B_CORE_PROPERTY_PROVIDER_GET_IFACE(self);
    ...
    if (tmp_error)
    {
        if (tmp_error->code == B_CORE_PROPERTY_PROVIDER_ERROR_NOT_FOUND)
        {
    ...
    {
        property_value = b_core_property_provider_get_internal_property(property_name, &tmp_error);
        if (tmp_error)
        {
            g_propagate_error(error, g_steal_pointer(&tmp_error));
            return NULL;
...
/**
 * b_core_property_provider_get_internal_property:
...
static gchar *b_core_property_provider_get_internal_property(const gchar *property_name, GError **error)
{
    ...
    if (!deviceServiceGetSystemProperty(property_name, &property_value))
    {
        g_set_error(error,
                    B_CORE_PROPERTY_PROVIDER_ERROR,
                    B_CORE_PROPERTY_PROVIDER_ERROR_NOT_FOUND,
                                                                 ...
                                                                 const gchar *default_value)
{
    ...
    g_autofree gchar *property_value = b_core_property_provider_get_property(self, property_name, &error);
    if (error)
    {
...
{
    g_return_val_if_fail(B_CORE_IS_PROPERTY_PROVIDER(self), default_value);
                                                              ...
                                                              gint8 default_value)
{
    ...
    gint64 value = b_core_property_provider_get_property_as_int64(self, property_name, default_value);
                                                                ...
                                                                guint8 default_value)
{
    ...
    guint64 value = b_core_property_provider_get_property_as_uint64(self, property_name, default_value);
    if (value > G_MAXUINT8)
    {
...
gboolean b_core_property_provider_set_property(BCorePropertyProvider *self,
                                                         ...
                                                         GError **error)
{
    g_return_val_if_fail(B_CORE_IS_PROPERTY_PROVIDER(self), FALSE);
    ...
    return b_core_property_provider_set_internal_property(self, property_name, property_value, error);
}


/**
 * b_core_property_provider_set_internal_property:
                                                                         ...
                                                                         GError **error)
{
    ...
    g_autofree gchar *old_value = b_core_property_provider_get_property(self, property_name, &tmp_error);
    if (tmp_error)
    {
        if (tmp_error->code != B_CORE_PROPERTY_PROVIDER_ERROR_NOT_FOUND)
        {
    ...
    if (!deviceServiceSetSystemProperty(property_name, property_value))
    {
        g_set_error(error,
                    B_CORE_PROPERTY_PROVIDER_ERROR,
                    B_CORE_PROPERTY_PROVIDER_ERROR_INTERNAL,
                    "Failed to set property");
        return FALSE;
    }
    else
    {
        b_core_propert_provider_emit_property_changed(self, property_name, old_value, property_value);
    }
                                                                ...
                                                                const gchar *property_value)
{
    ...
    g_autoptr(GError) error = NULL;
    if (!b_core_property_provider_set_property(self, property_name, property_value, &error))
    {
...
{
    return b_core_property_provider_set_property_string(
...
{
    return b_core_property_provider_set_property_int64(self, property_name, property_value);
}
                                                               ...
                                                               gint64 property_value)
{
    ...
    return b_core_property_provider_set_property_string(self, property_name, value);
}
...
{
    return b_core_property_provider_set_property_uint64(self, property_name, property_value);
}
