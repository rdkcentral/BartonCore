# SBMD Vendor/Product Claiming

## Purpose

Specifies how SBMD drivers claim devices by vendor and product ID: declaring vendor/product IDs in a driver spec, the `DeviceDataCache` accessors, claim semantics, and vendor-specific driver priority over generic drivers.
