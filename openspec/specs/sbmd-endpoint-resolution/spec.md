# SBMD Endpoint Resolution

## Purpose

Specifies how SBMD drivers resolve which Matter endpoint backs each resource: device-type matching to build an endpoint map during initialization, and cluster-based fallback when device-type matching alone is insufficient.
